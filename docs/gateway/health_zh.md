...
- Relink flow: `openclaw channels logout && openclaw channels login --verbose` when status codes 409–515 or `loggedOut` appear in logs. (注意: the QR login flow auto-restarts once for status 515 after pairing.)
