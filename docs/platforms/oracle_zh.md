...
**注意:** `build-essential` is required for ARM compilation of some dependencies.
...
> 注意: If you hit ARM-native build issues, start with system packages (e.g. `sudo apt install -y build-essential`) before reaching for Homebrew.
