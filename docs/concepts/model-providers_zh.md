[English](model-providers.md) | **[简体中文]**
...
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  ...
  - 注意: you do **not** paste a client id or secret into `openclaw.json`. The CLI login flow stores
...
另请参阅: [/gateway/configuration](/gateway/configuration) for full configuration examples.
