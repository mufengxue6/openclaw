...
import { createKimiCodingToolCallWrapper } from "./kimi-coding-stream-wrappers.js";
...
export function applyExtraParamsToAgent(
  ...
  // Apply Kimi Coding tool call response wrapper to parse text-based tool calls
  // GitHub Issue: #40157
  if (provider === "kimi-coding" || provider === "kimi-code") {
    agent.streamFn = createKimiCodingToolCallWrapper(agent.streamFn);
  }
